...
public:
	[[nodiscard]]  auto orientation() const noexcept
	{
		...
		else if ((horizontalBorder_ == BordersType::BEGIN || horizontalBorder_ == BordersType::END
			|| horizontalBorder_ == BordersType::INSIDE) && verticalBorder_ == BordersType::NONE) return CellOrientation::HORIZONTAL;
		else if ((verticalBorder_ == BordersType::BEGIN || verticalBorder_ == BordersType::END
			|| verticalBorder_ == BordersType::INSIDE) && horizontalBorder_ == BordersType::NONE) return CellOrientation::VERTICAL;
		return CellOrientation::TWO;
	}
